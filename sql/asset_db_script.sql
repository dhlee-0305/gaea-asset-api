...
(
  ...
  USAGE_DIVISION    VARCHAR(50)  NOT NULL COMMENT '용도구분(업무용,개발용,실증용)',
  USAGE_PURPOSE     VARCHAR(50) NOT NULL COMMENT '사용용도(개발업무용,내부망,외부망)',
...
/* DEVICE */
INSERT INTO DEVICE(OLD_DEVICE_ID, EMP_NUM, USAGE_DIVISION, USAGE_PURPOSE, ARCHIVE_LOCATION, DEVICE_TYPE, MANUFACTURER_CODE, MODEL_NAME, MANUFACTURE_DATE, CPU_SPEC, MEMORY_SIZE, STORAGE_INFO, OPERATING_SYSTEM, SCREEN_SIZE, GPU_SPEC, DEVICE_STATUS_CODE, PURCHASE_DATE, RETURN_DATE, REMARKS, CREATE_DATETIME, CREATE_USER, UPDATE_DATETIME, UPDATE_USER)VALUES('IT-PC-000592', 100001, '업무용', '개발업무용', '선릉 패스트파이브', '노트북', 'LG', '15Z90S-GP56ML', '2024', 'Ultra5 125H', 16, '256', '11/64', 15, '', '사용', '2024', '', '', NOW(), 100000, NOW(), 100000);
INSERT INTO DEVICE(OLD_DEVICE_ID, EMP_NUM, USAGE_DIVISION, USAGE_PURPOSE, ARCHIVE_LOCATION, DEVICE_TYPE, MANUFACTURER_CODE, MODEL_NAME, MANUFACTURE_DATE, CPU_SPEC, MEMORY_SIZE, STORAGE_INFO, OPERATING_SYSTEM, SCREEN_SIZE, GPU_SPEC, DEVICE_STATUS_CODE, PURCHASE_DATE, RETURN_DATE, REMARKS, CREATE_DATETIME, CREATE_USER, UPDATE_DATETIME, UPDATE_USER)VALUES('IT-PC-000589', 100002, '업무용', '개발업무용', '선릉 패스트파이브', '노트북', 'LG', '15Z90S-GP56ML', '2024', 'Ultra5 125H', 16, '256', '11/64', 15, '', '사용', '2024', '', '', NOW(), 100000, NOW(), 100000);
INSERT INTO DEVICE(OLD_DEVICE_ID, EMP_NUM, USAGE_DIVISION, USAGE_PURPOSE, ARCHIVE_LOCATION, DEVICE_TYPE, MANUFACTURER_CODE, MODEL_NAME, MANUFACTURE_DATE, CPU_SPEC, MEMORY_SIZE, STORAGE_INFO, OPERATING_SYSTEM, SCREEN_SIZE, GPU_SPEC, DEVICE_STATUS_CODE, PURCHASE_DATE, RETURN_DATE, REMARKS, CREATE_DATETIME, CREATE_USER, UPDATE_DATETIME, UPDATE_USER)VALUES('IT-PC-000589', 100009, '업무용', '개발업무용', '신세계푸드 본사', '노트북', '삼성', 'NT500R5S', '2016', 'i5-5200U', 8, '128/750', '10/64', 15, '', '사용', '2016', '', '신세계푸드 원격 접속용 반출 PC', NOW(), 100000, NOW(), 100000);
