...
(
  ...
  MEMORY_SIZE       VARCHAR(50)          NULL     COMMENT '메모리(GB, PC 전용)',
  STORAGE_INFO      VARCHAR(50)  NULL     COMMENT '스토리지 정보 (PC 전용)',
  OPERATING_SYSTEM  VARCHAR(100) NULL     COMMENT '운영체제',
  SCREEN_SIZE       VARCHAR(50) NULL     COMMENT '화면 크기 (PC/모니터 전용)',
...
(
  MESSAGE_NUM 			INT 		 NOT NULL AUTO_INCREMENT COMMENT '메세지 번호',
  RECIPIENT 			VARCHAR(255) NOT NULL COMMENT '수신자',
  SENDER 				VARCHAR(255) NOT NULL COMMENT '발신자',
  TITLE 				VARCHAR(255) NOT NULL COMMENT '제목',
  CONTENT 				TEXT 		 NOT NULL COMMENT '본문 내용',
  MESSAGE_STATUS_CODE	VARCHAR(2) 	 NULL COMMENT '메세지 상태 코드',
  CREATE_DATETIME 		DATETIME 	 NULL DEFAULT CURRENT_TIMESTAMP COMMENT '생성일시',
...
CREATE TABLE FILE
(
  FILE_NUM				INT 		 NOT NULL AUTO_INCREMENT COMMENT '파일 번호',
...
(
  VERIFICATION_NUM BIGINT      NOT NULL AUTO_INCREMENT COMMENT '인증순번',
  USER_ID          VARCHAR(50) NOT NULL COMMENT '사용자 ID',
  CODE             CHAR(6)     NOT NULL COMMENT '인증코드',
  IS_VERIFIED      BOOLEAN     NULL     DEFAULT FALSE COMMENT '인증여부',
  EXPIRES_DATETIME DATETIME    NOT NULL COMMENT '만료일시',
  CREATE_DATETIME  DATETIME    NULL     DEFAULT CURRENT_TIMESTAMP COMMENT '생성일시',
  PRIMARY KEY (VERIFICATION_NUM)
);
...
INSERT INTO ORGANIZATION (ORG_ID, ORG_NAME, ORG_TYPE, PARENT_ORG_ID, ORG_LEVEL, SORT_ORDER, IS_ACTIVE, CREATE_DATETIME) VALUES
(13, '광고사업부문', 'DIVISION', 1, 2, 3, 'Y', NOW()),
(14, '이커머스부문', 'DIVISION', 1, 2, 4, 'Y', NOW()),
(15, '솔루션사업부', 'DIVISION', 1, 2, 5, 'Y', NOW());

INSERT INTO ORGANIZATION (ORG_ID, ORG_NAME, ORG_TYPE, PARENT_ORG_ID, ORG_LEVEL, SORT_ORDER, IS_ACTIVE, CREATE_DATETIME) VALUES
(2, '오아시스', 'COMPANY', NULL, 1, 2, 'Y', NOW());

/* COMMON_CODE */
INSERT INTO COMMON_CODE (CATEGORY, CATEGORY_NAME, CODE, CODE_NAME, USE_YN) VALUES
('C001', '직책', '03', '팀장', 'Y'),
('C001', '직책', '04', '팀원', 'Y'),
('C002', '직위', '03', '부장', 'Y'),
('C002', '직위', '04', '차장', 'Y'),
...
('C002', '직위', '07', '사원', 'Y'),
('C003', '권한', '00', 'User', 'Y'),
('C003', '권한', '01', 'Team-manager', 'Y'),
('C003', '권한', '02', 'Asset-manager', 'Y'),
('C003', '권한', '03', 'System-manager', 'Y'),
('C004', '장비유형코드', 'PC', '컴퓨터', 'Y'),
('C004', '장비유형코드', 'MO', '모니터', 'Y'),
('C004', '장비유형코드', 'HP', '핸드폰', 'Y'),
('C004', '장비유형코드', 'ETC', '기타', 'Y'),
('C005', '장비상태코드', '01', '사용', 'Y'),
('C005', '장비상태코드', '02', '반납', 'Y'),
('C005', '장비상태코드', '03', '파손', 'Y'),
('C005', '장비상태코드', '04', '폐기', 'Y'),
('C006', '결재상태코드', 'A1', '부서장 승인대기', 'Y'),
('C006', '결재상태코드', 'A2', '관리자 승인대기', 'Y'),
('C006', '결재상태코드', 'A3', '승인완료', 'Y'),
('C006', '결재상태코드', 'A4', '반려', 'Y'),
('C007', '용도구분', '01', '업무용', 'Y'),
('C007', '용도구분', '02', '개발용', 'Y'),
('C007', '용도구분', '03', '실증용', 'Y'),
...
('C008', '메세지상태코드', 'M5', '비밀번호 초기화 OTP', 'Y'),
...
/* DEVICE */
INSERT INTO DEVICE (OLD_DEVICE_ID,EMP_NUM,USAGE_DIVISION,USAGE_PURPOSE,ARCHIVE_LOCATION,DEVICE_TYPE,MANUFACTURER,MODEL_NAME,MANUFACTURE_DATE,CPU_SPEC,MEMORY_SIZE,STORAGE_INFO,OPERATING_SYSTEM,SCREEN_SIZE,GPU_SPEC,DEVICE_STATUS_CODE,APPROVAL_STATUS_CODE,PURCHASE_DATE,RETURN_DATE,REMARKS,CREATE_DATETIME,CREATE_USER,UPDATE_DATETIME,UPDATE_USER) VALUES
('IT-PC-000592',100001,'01','개발업무용','선릉 패스트파이브','PC','LG','15Z90S-GP56ML','2024','Ultra5 125H','16','256','11/64','15.0','','01','','20240101','','','2025-08-08 15:21:30',100000,'2025-08-08 15:24:30',100000),
('IT-PC-000589',100002,'01','개발업무용','선릉 패스트파이브','PC','LG','15Z90S-GP56ML','2024','Ultra5 125H','16','256','11/64','15.0','','01','','20240101','','','2025-08-08 15:22:30',100000,'2025-08-08 15:24:30',100000),
('IT-PC-000589',100009,'02','개발업무용','신세계푸드 본사','PC','삼성','NT500R5S','2016','i5-5200U','8','128/750','10/64','15.0','','02','','20160101','','신세계푸드 원격 접속용 반출 PC','2025-08-08 15:24:30',100000,'2025-08-08 15:24:30',100000),
('IT-MO-200036',100000,'02','개발업무용','선릉 패스트파이브','MO','DELL','P2419H','2020','',NULL,'','','24.0',NULL,'01',NULL,'20220810','','','2025-08-08 15:29:56',100007,'2025-08-08 15:34:51',100007),
('IT-MO-200038',100011,'02','개발업무용','선릉 패스트파이브','MO','LG','24QP500','2021','',NULL,'','','24.0',NULL,'03',NULL,'20210804','','','2025-08-08 15:30:53',100007,'2025-08-08 15:35:21',100007),
('',100003,'02','테스트 폰','선릉 패스트파이브','HP','삼성','SM-F936N','2022','',NULL,'','AOS',NULL,NULL,'04',NULL,'20220824','','','2025-08-08 15:32:43',100007,'2025-08-08 15:32:43',NULL),
('',100003,'02','테스트 폰','선릉 패스트파이브','HP','Apple','아이폰 SE(2세대)','2020','',NULL,'','iOS',NULL,NULL,'01',NULL,'20220601','','','2025-08-08 15:33:38',100007,'2025-08-08 15:33:38',NULL),
('',100000,'03','선풍기','본사','ETC','','MORITZ','2019','',NULL,'','',NULL,NULL,'01',NULL,'','20250616','','2025-08-08 15:34:25',100007,'2025-08-08 15:34:25',NULL);
